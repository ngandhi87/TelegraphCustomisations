	...
	<xsl:template match="/">
		...
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" font-family="Liberation Sans">
			...
			<fo:layout-master-set>
				<fo:simple-page-master master-name="PageMaster" page-height="420mm" page-width="297mm" margin-top="1cm" margin-bottom="5mm" margin-left="1cm" margin-right="1cm">
					<fo:region-body margin-bottom="4cm" margin-top="1cm"/>
			...
			<fo:page-sequence initial-page-number="1" master-reference="PageMaster">
				...
				<fo:static-content flow-name="xsl-region-before">
					<fo:block text-align="center" font-size="9pt">
						<xsl:value-of select="/XMLData/XMLDataObjects/XMLDataObject[1]/attributes/attribute[@name='PRINT_Large_A3_contact']"/> -
