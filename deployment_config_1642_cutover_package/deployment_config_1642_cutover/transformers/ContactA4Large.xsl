...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg">
	...
	<xsl:template match="*">
		...
		<fo:table table-layout="fixed" font-size="10pt" height="89mm"  keep-together.within-page="always">
			<fo:table-column column-number="1" column-width="80mm" />
			<fo:table-body>
				<xsl:choose>
					<xsl:when test="contains('deleted', state)">
						<fo:table-row height="81mm">
						...
						<fo:table-row height="81mm">
								...
								<fo:block text-align="center">
									<xsl:call-template name="generateimagetag">
										...
										<xsl:with-param name="maxwidth">78</xsl:with-param>
										<xsl:with-param name="maxheight">78</xsl:with-param>
						...
						<fo:table-row height="81mm">
								...
								<fo:block font-size="10pt" font-weight="bold" space-after="2mm">
									<xsl:call-template name="displaycaptiontext">
										...
										<xsl:with-param name="maxchar">100</xsl:with-param>
									</xsl:call-template>
								</fo:block>
								<fo:block font-size="10pt">
									<xsl:call-template name="displaycaptiontext">
										<xsl:with-param name="text" select="attributes/attribute[@name='STORY']"/>
										<xsl:with-param name="maxchar">700</xsl:with-param>
									</xsl:call-template>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
	...
	<xsl:template match="/">
		...
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" font-family="Liberation Sans">
			...
			<fo:layout-master-set>
				<fo:simple-page-master master-name="PageMaster" page-height="297mm" page-width="210mm" margin-top="8mm" margin-bottom="5mm" margin-left="1cm" margin-right="1cm">
					<fo:region-body margin-bottom="8mm" margin-top="8mm"/>
			...
			<fo:page-sequence initial-page-number="1" master-reference="PageMaster">
				<fo:static-content flow-name="xsl-region-before">
					<fo:block text-align="center" font-size="9pt">
						<xsl:value-of select="/XMLData/XMLDataObjects/XMLDataObject[1]/attributes/attribute[@name='PRINT_Large_A4_contact']"/> -
				...
				<fo:flow flow-name="xsl-region-body">
					<fo:table table-layout="fixed" font-size="10pt">
						...
						<fo:table-column column-number="4" column-width="80mm" />
						...
						<fo:table-body>
							...
							<fo:table-row>
								...
								<fo:table-cell>
									<fo:block>
										<xsl:apply-templates select="XMLData/XMLDataObjects/XMLDataObject[position() mod 2 = 1]"/>
									</fo:block>
								</fo:table-cell>
								...
								<fo:table-cell>
									<fo:block>
										<xsl:apply-templates select="XMLData/XMLDataObjects/XMLDataObject[position() mod 2 = 0]"/>
									</fo:block>
								</fo:table-cell>
						</fo:table-row>
						</fo:table-body>
